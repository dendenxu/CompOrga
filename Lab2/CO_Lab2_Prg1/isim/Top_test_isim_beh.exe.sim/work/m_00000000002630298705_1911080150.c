...
LAB16:    t25 = (t0 + 8824);
    ...
    t29 = (t28 + 56U);
    t30 = *((char **)t29);
    xsi_vlog_bit_copy(t30, 0, t3, 0, 65);
    xsi_driver_vfirst_trans(t25, 0, 64);
    t31 = (t0 + 8328);
    *((int *)t31) = 1;
...
LAB8:    t17 = (t0 + 1936U);
    t18 = *((char **)t17);
    t17 = ((char*)((ng2)));
    xsi_vlogtype_concat(t16, 65, 65, 2U, t17, 1, t18, 64);
    goto LAB9;

LAB10:    t24 = ((char*)((ng2)));
    t25 = (t0 + 1936U);
    t26 = *((char **)t25);
    xsi_vlogtype_concat(t23, 65, 65, 2U, t26, 64, t24, 1);
    goto LAB11;

LAB12:    xsi_vlog_unsigned_bit_combine(t3, 65, t16, 65, t23, 65);
    goto LAB16;
...
LAB8:    t18 = (t0 + 3536U);
    t19 = *((char **)t18);
    xsi_vlog_get_part_select_value(t17, 64, t19, 64, 1);
    xsi_vlog_unary_and(t16, 1, t17, 64);
    goto LAB9;

LAB10:    t18 = (t0 + 3536U);
    t26 = *((char **)t18);
    xsi_vlog_get_part_select_value(t25, 64, t26, 63, 0);
    xsi_vlog_unary_and(t24, 1, t25, 64);
    goto LAB11;
...
extern void work_m_00000000002630298705_1911080150_init()
{
	...
	xsi_register_didat("work_m_00000000002630298705_1911080150", "isim/Top_test_isim_beh.exe.sim/work/m_00000000002630298705_1911080150.didat");
